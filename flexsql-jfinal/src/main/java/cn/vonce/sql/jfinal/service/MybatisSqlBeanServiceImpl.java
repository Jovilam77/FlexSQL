...
public class MybatisSqlBeanServiceImpl<T, ID> extends BaseSqlBeanServiceImpl<T> implements SqlBeanService<T, ID>, AdvancedDbManageService<T> {
    ...
    /**
     * 获取MybatisSqlBeanDao（使用SqlSessionManager确保线程安全和资源管理）
     */
    private MybatisSqlBeanDao<T> getDao() {
        return sqlSessionManager.getMapper(MybatisSqlBeanDao.class);
    }
    ...
    public T selectById(ID id) {
        ...
        return getDao().selectById(getSqlBeanMeta(), clazz, id);
    }
    ...
    public <R> R selectById(Class<R> returnType, ID id) {
        ...
        return getDao().selectByIdO(getSqlBeanMeta(), clazz, returnType, id);
    }
    ...
    public List<T> selectByIds(ID... ids) {
        ...
        return getDao().selectByIds(getSqlBeanMeta(), clazz, ids);
    }
    ...
    public <R> List<R> selectByIds(Class<R> returnType, ID... ids) {
        ...
        return getDao().selectByIdsO(getSqlBeanMeta(), clazz, returnType, ids);
    }

    @DbSwitch(DbRole.SLAVE)
    @Override
    public T selectOne(Select select) {
        return getDao().selectOne(getSqlBeanMeta(), clazz, select);
    }

    @DbSwitch(DbRole.SLAVE)
    @Override
    public <R> R selectOne(Class<R> returnType, Select select) {
        return getDao().selectOneO(getSqlBeanMeta(), clazz, returnType, select);
    }

    @DbSwitch(DbRole.SLAVE)
    @Override
    public Map<String, Object> selectMap(Select select) {
        return getDao().selectMap(getSqlBeanMeta(), clazz, select);
    }

    @DbSwitch(DbRole.SLAVE)
    @Override
    public T selectOneBy(String where, Object... args) {
        return getDao().selectOneBy(getSqlBeanMeta(), clazz, where, args);
    }

    @DbSwitch(DbRole.SLAVE)
    @Override
    public <R> R selectOneBy(Class<R> returnType, String where, Object... args) {
        return getDao().selectOneByO(getSqlBeanMeta(), clazz, returnType, where, args);
    }
    ...
    public <R> List<R> selectBy(Class<R> returnType, String where, Object... args) {
        return getDao().selectByO(getSqlBeanMeta(), clazz, returnType, null, where, args);
    }
    ...
    public <R> List<R> selectBy(Class<R> returnType, Wrapper wrapper) {
        Select select = new Select();
        select.where(wrapper);
        return getDao().selectO(getSqlBeanMeta(), clazz, returnType, select);
    }
    ...
    public <R> List<R> selectBy(Class<R> returnType, Paging paging, String where, Object... args) {
        return getDao().selectByO(getSqlBeanMeta(), clazz, returnType, paging, where, args);
    }
    ...
    public List<T> selectBy(String where, Object... args) {
        return getDao().selectBy(getSqlBeanMeta(), clazz, null, where, args);
    }
    ...
    public List<T> selectBy(Wrapper wrapper) {
        Select select = new Select();
        select.where(wrapper);
        return getDao().select(getSqlBeanMeta(), clazz, select);
    }
    ...
    public List<T> selectBy(Paging paging, String where, Object... args) {
        return getDao().selectBy(getSqlBeanMeta(), clazz, paging, where, args);
    }
    ...
    public int countBy(String where, Object... args) {
        return getDao().countBy(getSqlBeanMeta(), clazz, where, args);
    }
    ...
    public int countBy(Wrapper wrapper) {
        Select select = new Select();
        select.where(wrapper);
        return getDao().count(getSqlBeanMeta(), clazz, null, select);
    }
    ...
    @Override
    public int count() {
        return getDao().countBy(getSqlBeanMeta(), clazz, null);
    }

    @DbSwitch(DbRole.SLAVE)
    @Override
    public List<T> select() {
        return getDao().selectAll(getSqlBeanMeta(), clazz, null);
    }

    @DbSwitch(DbRole.SLAVE)
    @Override
    public List<T> select(Paging paging) {
        return getDao().selectAll(getSqlBeanMeta(), clazz, paging);
    }

    @DbSwitch(DbRole.SLAVE)
    @Override
    public <R> List<R> select(Class<R> returnType) {
        return getDao().selectAllO(getSqlBeanMeta(), clazz, returnType, null);
    }

    @DbSwitch(DbRole.SLAVE)
    @Override
    public <R> List<R> select(Class<R> returnType, Paging paging) {
        return getDao().selectAllO(getSqlBeanMeta(), clazz, returnType, paging);
    }

    @DbSwitch(DbRole.SLAVE)
    @Override
    public List<Map<String, Object>> selectMapList(Select select) {
        return getDao().selectMapList(getSqlBeanMeta(), clazz, select);
    }
    ...
    public int count(Class<?> returnType, Select select) {
        return getDao().count(getSqlBeanMeta(), clazz, returnType, select);
    }
    ...
    public int deleteById(ID... id) {
        ...
        return getDao().deleteById(getSqlBeanMeta(), clazz, id);
    }

    @DbSwitch(DbRole.MASTER)
    @Override
    public int deleteBy(String where, Object... args) {
        return getDao().deleteBy(getSqlBeanMeta(), clazz, where, args);
    }
    ...
    public int deleteBy(Wrapper wrapper) {
        ...
        return getDao().delete(getSqlBeanMeta(), clazz, delete, false);
    }
    ...
    public int delete(Delete delete, boolean ignore) {
        return getDao().delete(getSqlBeanMeta(), clazz, delete, ignore);
    }
    ...
    public int logicallyDeleteById(ID... id) {
        ...
        return getDao().logicallyDeleteById(getSqlBeanMeta(), clazz, id);
    }

    @DbSwitch(DbRole.MASTER)
    @Override
    public int logicallyDeleteBy(String where, Object... args) {
        return getDao().logicallyDeleteBy(getSqlBeanMeta(), clazz, where, args);
    }

    @DbSwitch(DbRole.MASTER)
    @Override
    public int logicallyDeleteBy(Wrapper wrapper) {
        return getDao().logicallyDeleteByWrapper(getSqlBeanMeta(), clazz, wrapper);
    }
    ...
    public int update(Update<T> update) {
        return getDao().update(getSqlBeanMeta(), clazz, update, false);
    }

    @DbSwitch(DbRole.MASTER)
    @Override
    public int update(Update<T> update, boolean ignore) {
        return getDao().update(getSqlBeanMeta(), clazz, update, ignore);
    }

    @DbSwitch(DbRole.MASTER)
    @Override
    public int updateById(T bean, ID id) {
        return getDao().updateById(getSqlBeanMeta(), clazz, bean, id, true, false, null);
    }

    @DbSwitch(DbRole.MASTER)
    @Override
    public int updateById(T bean, ID id, boolean updateNotNull, boolean optimisticLock) {
        return getDao().updateById(getSqlBeanMeta(), clazz, bean, id, updateNotNull, optimisticLock, null);
    }

    @DbSwitch(DbRole.MASTER)
    @Override
    public int updateByBeanId(T bean) {
        return getDao().updateByBeanId(getSqlBeanMeta(), clazz, bean, true, false, null);
    }

    @DbSwitch(DbRole.MASTER)
    @Override
    public int updateById(T bean, ID id, boolean updateNotNull, boolean optimisticLock, Column... filterColumns) {
        return getDao().updateById(getSqlBeanMeta(), clazz, bean, id, updateNotNull, optimisticLock, filterColumns);
    }

    @DbSwitch(DbRole.MASTER)
    @Override
    public <R> int updateById(T bean, ID id, boolean updateNotNull, boolean optimisticLock, ColumnFun<T, R>... filterColumns) {
        return getDao().updateById(getSqlBeanMeta(), clazz, bean, id, updateNotNull, optimisticLock, SqlBeanUtil.funToColumn(filterColumns));
    }
    ...
    public int updateByBeanId(T bean, boolean updateNotNull, boolean optimisticLock) {
        return getDao().updateByBeanId(getSqlBeanMeta(), clazz, bean, updateNotNull, optimisticLock, null);
    }

    @DbSwitch(DbRole.MASTER)
    @Override
    public int updateByBeanId(T bean, boolean updateNotNull, boolean optimisticLock, Column... filterColumns) {
        return getDao().updateByBeanId(getSqlBeanMeta(), clazz, bean, updateNotNull, optimisticLock, filterColumns);
    }

    @DbSwitch(DbRole.MASTER)
    @Override
    public <R> int updateByBeanId(T bean, boolean updateNotNull, boolean optimisticLock, ColumnFun<T, R>... filterColumns) {
        return getDao().updateByBeanId(getSqlBeanMeta(), clazz, bean, updateNotNull, optimisticLock, SqlBeanUtil.funToColumn(filterColumns));
    }

    @DbSwitch(DbRole.MASTER)
    @Override
    public int updateBy(T bean, boolean updateNotNull, boolean optimisticLock, String where, Object... args) {
        return getDao().updateBy(getSqlBeanMeta(), clazz, bean, updateNotNull, optimisticLock, null, where, args);
    }
    ...
    public int updateBy(T bean, boolean updateNotNull, boolean optimisticLock, Column[] filterColumns, String where, Object... args) {
        return getDao().updateBy(getSqlBeanMeta(), clazz, bean, updateNotNull, optimisticLock, filterColumns, where, args);
    }
    ...
    public int updateByBean(T bean, String where) {
        return getDao().updateByBean(getSqlBeanMeta(), clazz, bean, true, false, where, null);
    }

    @DbSwitch(DbRole.MASTER)
    @Override
    public int updateByBean(T bean, boolean updateNotNull, boolean optimisticLock, String where) {
        return getDao().updateByBean(getSqlBeanMeta(), clazz, bean, updateNotNull, optimisticLock, where, null);
    }

    @DbSwitch(DbRole.MASTER)
    @Override
    public int updateByBean(T bean, boolean updateNotNull, boolean optimisticLock, String where, Column... filterColumns) {
        return getDao().updateByBean(getSqlBeanMeta(), clazz, bean, updateNotNull, optimisticLock, where, filterColumns);
    }

    @DbSwitch(DbRole.MASTER)
    @Override
    public <R> int updateByBean(T bean, boolean updateNotNull, boolean optimisticLock, String where, ColumnFun<T, R>... filterColumns) {
        return getDao().updateByBean(getSqlBeanMeta(), clazz, bean, updateNotNull, optimisticLock, where, SqlBeanUtil.funToColumn(filterColumns));
    }
    ...
    public int insert(T... bean) {
        ...
        int count = getDao().insertBean(getSqlBeanMeta(), clazz, beanList);
        return count;
    }
    ...
    public int insert(Insert<T> insert) {
        int count = getDao().insert(getSqlBeanMeta(), clazz, insert);
        return count;
    }
    ...
    public String backup() {
        ...
        getDao().backup(getSqlBeanMeta(), clazz, null, null, targetTableName, null);
    ...
    public void backup(String targetSchema, String targetTableName) {
        getDao().backup(getSqlBeanMeta(), clazz, null, targetSchema, targetTableName, null);
    }

    @DbSwitch(DbRole.MASTER)
    @Override
    public void backup(Wrapper wrapper, String targetSchema, String targetTableName) {
        getDao().backup(getSqlBeanMeta(), clazz, wrapper, targetSchema, targetTableName, null);
    }
    ...
    public void backup(Wrapper wrapper, String targetTableName, Column... columns) {
        getDao().backup(getSqlBeanMeta(), clazz, wrapper, null, targetTableName, columns);
    }
    ...
    public <R> void backup(Wrapper wrapper, String targetTableName, ColumnFun<T, R>... columns) {
        getDao().backup(getSqlBeanMeta(), clazz, wrapper, null, targetTableName, SqlBeanUtil.funToColumn(columns));
    }
    ...
    public void backup(Wrapper wrapper, String targetSchema, String targetTableName, Column... columns) {
        getDao().backup(getSqlBeanMeta(), clazz, wrapper, targetSchema, targetTableName, columns);
    }
    ...
    public <R> void backup(Wrapper wrapper, String targetSchema, String targetTableName, ColumnFun<T, R>... columns) {
        getDao().backup(getSqlBeanMeta(), clazz, wrapper, targetSchema, targetTableName, SqlBeanUtil.funToColumn(columns));
    }
    ...
    public int copy(Wrapper wrapper, String targetTableName) {
        return getDao().copy(getSqlBeanMeta(), clazz, wrapper, null, targetTableName, null);
    }
    ...
    public int copy(Wrapper wrapper, String targetSchema, String targetTableName) {
        return getDao().copy(getSqlBeanMeta(), clazz, wrapper, targetSchema, targetTableName, null);
    }
    ...
    public int copy(Wrapper wrapper, String targetTableName, Column... columns) {
        return getDao().copy(getSqlBeanMeta(), clazz, wrapper, null, targetTableName, columns);
    }
    ...
    public <R> int copy(Wrapper wrapper, String targetTableName, ColumnFun<T, R>... columns) {
        return getDao().copy(getSqlBeanMeta(), clazz, wrapper, null, targetTableName, SqlBeanUtil.funToColumn(columns));
    }
    ...
    public int copy(Wrapper wrapper, String targetSchema, String targetTableName, Column... columns) {
        return getDao().copy(getSqlBeanMeta(), clazz, wrapper, targetSchema, targetTableName, columns);
    }
    ...
    public <R> int copy(Wrapper wrapper, String targetSchema, String targetTableName, ColumnFun<T, R>... columns) {
        return getDao().copy(getSqlBeanMeta(), clazz, wrapper, targetSchema, targetTableName, SqlBeanUtil.funToColumn(columns));
    }
    ...
    public List<String> getSchemas(String name) {
        ...
        return getDao().databases(getSqlBeanMeta(), name);
    }
    ...
    public int createSchema(String name) {
        ...
        return getDao().createSchema(getSqlBeanMeta(), name);
    }
    ...
    public int dropSchema(String name) {
        ...
        return getDao().dropSchema(getSqlBeanMeta(), name);
    }
    ...
    public void dropTable() {
        ...
        if (sqlBeanMate.getDbType() != DbType.MySQL && sqlBeanMate.getDbType() != DbType.MariaDB && sqlBeanMate.getDbType() != DbType.Postgresql && sqlBeanMate.getDbType() != DbType.SQLServer && sqlBeanMate.getDbType() != DbType.H2) {
            List<TableInfo> nameList = getDao().selectTableList(getSqlBeanMeta(), SqlBeanUtil.getTable(clazz).getSchema(), SqlBeanUtil.getTable(clazz).getName());
            if (nameList == null || nameList.isEmpty()) {
                return;
            }
        }
        getDao().drop(sqlBeanMate, clazz);
    }

    @DbSwitch(DbRole.MASTER)
    @Override
    public void createTable() {
        getDao().create(getSqlBeanMeta(), clazz);
    }
    ...
    public List<TableInfo> getTableList(String schema, String tableName) {
        return getDao().selectTableList(getSqlBeanMeta(), schema, tableName);
    }
    ...
    public List<ColumnInfo> getColumnInfoList(String schema, String tableName) {
        List<ColumnInfo> columnInfoList = getDao().selectColumnInfoList(getSqlBeanMeta(), schema, tableName);
